...
The communication between the LTI Consumer (platform), browser, and LTI Tool generally follows these steps (in principle, enumerated items correspond to arrow-like transitions on the diagram above):
